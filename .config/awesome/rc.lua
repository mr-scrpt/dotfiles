...
-- local kbdcfg = require("lang-swithc.kbdcfg")

-- local kbdcfg = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "kbdcfg")
-- {{{ Error handling
...
--awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒" }
-- awful.util.tagnames = { "⠐", "⠡", "⠲", "⠵", "⠻", "⠿" }
awful.util.tagnames = { "main", "browser", "msg", "media", "etc" }
...
globalkeys = my_table.join(
 ...
 -- Show/Hide Systray
    ...
    -- awful.key({ modkey,           }, "t", function () awful.spawn("telegram-desctop") end,
    --           {description = terminal, group = "super"}),
  --           resize tile
    awful.key({ modkey1, altkey   }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey1, altkey   }, "h",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    -- Brightness
    -- awful.key({ altkey, }, "XF86MonBrightnessUp", function () os.execute("xbacklight -inc 10") end,
